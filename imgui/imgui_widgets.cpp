...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    if (held)
    {
        window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max,
            ...
            ImColor(34 / 255.f, 34 / 255.f, 34 / 255.f, g.Style.Alpha));
        window->DrawList->AddRect(bb.Min, bb.Max, ImColor(12, 12, 12, 255));
        window->DrawList->AddRect(bb.Min + ImVec2(1, 1), bb.Max - ImVec2(1, 1), ImColor(50, 50, 50, 255));
        window->DrawList->AddRect(bb.Min + ImVec2(2, 2), bb.Max - ImVec2(2, 2), ImColor(12, 12, 12, 255));
    }
    else
        window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max,
            ImColor(34 / 255.f, 34 / 255.f, 34 / 255.f, g.Style.Alpha),
    ...
    PushFont(GetIO().Fonts->Fonts[3]);
    window->DrawList->PushClipRect(bb.Min, bb.Max, true);


    window->DrawList->AddText(bb.Min + ImVec2((bb.Max.x - bb.Min.x) / 2 - label_size.x / 2 + 1, (bb.Max.y - bb.Min.y) / 2 - label_size.y / 2 + 1), ImColor(15 / 255.f, 15 / 255.f, 15 / 255.f, g.Style.Alpha), label);
    window->DrawList->AddText(bb.Min + ImVec2((bb.Max.x - bb.Min.x) / 2 - label_size.x / 2 + 1, (bb.Max.y - bb.Min.y) / 2 - label_size.y / 2 ), ImColor(15 / 255.f, 15 / 255.f, 15 / 255.f, g.Style.Alpha), label);
    window->DrawList->AddText(bb.Min + ImVec2((bb.Max.x - bb.Min.x) / 2 - label_size.x / 2, (bb.Max.y - bb.Min.y) / 2 - label_size.y / 2 + 1), ImColor(15 / 255.f, 15 / 255.f, 15 / 255.f, g.Style.Alpha), label);
...
bool ImGui::ButtonEx_2(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    if (held)
    {
        window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max,
            ...
            ImColor(34 / 255.f, 34 / 255.f, 34 / 255.f, g.Style.Alpha));
        window->DrawList->AddRect(bb.Min, bb.Max, ImColor(12, 12, 12, 255));
        window->DrawList->AddRect(bb.Min + ImVec2(2, 2), bb.Max - ImVec2(2, 2), ImColor(50, 50, 50, 255));
        window->DrawList->AddRect(bb.Min + ImVec2(3, 3), bb.Max - ImVec2(3, 2), ImColor(12, 12, 12, 255));
    }
    else
    {
        window->DrawList->AddRectFilledMultiColor(bb.Min, bb.Max,
...
bool ImGui::Button_load(const char* label, const ImVec2& size_arg)
{
    return ButtonEx_2(label, size_arg, ImGuiButtonFlags_None);
}
...
{
    IM_ASSERT(!(flags & ImGuiInputTextFlags_Multiline)); // call InputTextMultiline()
    return InputTextEx(label, hint, buf, (int)buf_size, ImVec2(159, 19), flags, callback, user_data);
}
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (render_cursor || render_selection)
    {
        ...
        if (render_selection)
        {
            ...
            ImU32 bg_color = ImColor(178, 5, 64, 255); // FIXME: current code flow mandate that render_cursor is always true here, we are leaving the transparent one for tests.
            ...
            for (const ImWchar* p = text_selected_begin; p < text_selected_end; )
            {
                ...
                else
                {
                    ...
                    if (rect.Overlaps(clip_rect))
                        ...
                        draw_window->DrawList->AddRectFilled(rect.Min + nigga, rect.Max + nigga, ImColor(96, 128, 0));
                        //draw_window->DrawList->AddRectFilled(rect.Min + nigga, rect.Max + nigga, bg_color);
                }
        ...
        if (is_multiline || (buf_display_end - buf_display) < buf_display_max_length)
        {
           ...
           draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos + nigga + ImVec2(2, 0), ImColor(20, 20, 20), buf_display, buf_display + (buf_display_end - buf_display), 0.0f, is_multiline ? NULL : &clip_rect);
           draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos + nigga + ImVec2(0, 2), ImColor(20, 20, 20), buf_display, buf_display + (buf_display_end - buf_display), 0.0f, is_multiline ? NULL : &clip_rect);
           draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos + nigga + ImVec2(2, 2), ImColor(20, 20, 20), buf_display, buf_display + (buf_display_end - buf_display), 0.0f, is_multiline ? NULL : &clip_rect);
           ...
           draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos + nigga - ImVec2(2, 2), ImColor(20, 20, 20), buf_display, buf_display + (buf_display_end - buf_display), 0.0f, is_multiline ? NULL : &clip_rect);
            ...
            draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos - draw_scroll+ nigga, col, buf_display, buf_display + (buf_display_end - buf_display), 0.0f, is_multiline ? NULL : &clip_rect);

            //draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos - draw_scroll, GetColorU32(ImGuiCol_Text), buf_display, buf_display + (buf_display_end - buf_display), 0.0f, is_multiline ? NULL : &clip_rect);
        }
        ...
        if (render_cursor)
        {
            ...
            ImVec2 cursor_screen_pos = ImFloor(draw_pos + cursor_offset - draw_scroll + nigga);
            ImRect cursor_screen_rect(cursor_screen_pos.x, cursor_screen_pos.y - g.FontSize + 0.5f, cursor_screen_pos.x + 1.0f, cursor_screen_pos.y - 1.5f);
            if (cursor_is_visible && cursor_screen_rect.Overlaps(clip_rect))
                draw_window->DrawList->AddLine(cursor_screen_rect.Min - ImVec2(0, -1), cursor_screen_rect.GetBL() - ImVec2(0, 1), ImColor(96, 128, 0));
    ...
    ImVec2 nigga = ImVec2(5, 3);
        ...
        if (is_multiline || (buf_display_end - buf_display) < buf_display_max_length)
        {
            ...
            draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos + nigga, col, buf_display, buf_display + (buf_display_end - buf_display), 0.0f, is_multiline ? NULL : &clip_rect);


            draw_window->DrawList->AddText(g.Font, g.FontSize, draw_pos + nigga , col, buf_display, buf_display_end, 0.0f, is_multiline ? NULL : &clip_rect);
        }
    }
